...
const Toast = ({ toast, onClose }) => {
    ...
    return (
        <div className={`fixed top-5 right-5 z-[70] flex items-center gap-3 px-6 py-4 rounded-xl shadow-2xl backdrop-blur-md border animate-in slide-in-from-right fade-in duration-300 ${toast.type === 'error' ? 'bg-red-50/90 border-red-200 text-red-800' :
                                        ...
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <div className="relative">
                                                <select
                                                    ...
                                                    className={`w-full p-2 pl-3 pr-8 rounded-xl text-xs font-bold outline-none border cursor-pointer transition disabled:opacity-50 appearance-none shadow-sm ${order.orderStatus === 'delivered' ? 'bg-green-50 text-green-700 border-green-200' :
